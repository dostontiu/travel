@if(count($posts)>0)
        ...
        @foreach($posts as $post)
            @if ($post->postTourContent['lang_id'] != session()->get('locale_id'))
                @continue    // shu logikani to'g'irlash kerak!
            @endif
                    ...
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="{{ route('posttour.show',$post->id) }}">
                                    <img src="{{ asset('images') .'/'. (isset($post->imgPostTour->first()->name) ?  $post->imgPostTour->first()->name : '/noimage.jpg') }}"class="img-responsive" alt="Image">
                        ...
                        <div class="tour_title">
                            <h3><strong>{{$post->postTourContent['title']}}</strong></h3>
                            <div class="rating">
                                <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><small>(75)</small>
                                <div style="float: right">
                                    <a href="{{ 'region/' .$post->region->id }}">
                ...
                <div class="strip_all_tour_list wow fadeIn" data-wow-delay="{{$delaycount+=0.1}}s">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <div class="img_list">
                                <a href="{{ route('posttour.show',$post->id) }}">
                                    <img src="{{ asset('images') .'/'. (isset($post->imgPostTour->first()->name) ?  $post->imgPostTour->first()->name : '/noimage.jpg') }}" alt="Image">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="tour_list_desc">
                                ...
                                <h3>
                                    <strong>
                                        {{ $post->postTourContent['title'] }}
                                    </strong>
                                </h3>
                                <p class="tour_title">{{ str_limit($post->postTourContent['description'], 200)}}</p>
                                <ul class="add_info">
                                    <li>
...
@else
    <h2 class="text-center bg-danger">Nothing to show</h2>
@endif
